...
CREATE TABLE `diffs` (
  ...
  CONSTRAINT `diffs_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
...
CREATE TABLE `documents` (
  ...
  `last_diff_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-09-11 22:09:30
